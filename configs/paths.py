...
DATASET_PARTS_NAMES:List[str] = [TRAIN_INODE_NAME, TEST_INODE_NAME]
...
PART_NAME_2_WAVS_DIR_PATH:Dict[str, Path] = {
    TRAIN_INODE_NAME: DUSHA_CROWD_TRAIN_WAVS_DIR_PATH,
    TEST_INODE_NAME: DUSHA_CROWD_TEST_WAVS_DIR_PATH,
}
...
PROCESSED_DUSHA_CROWD_MODELS_PREDICTS_DIR_PATH:Path = PROCESSED_DUSHA_CROWD_DIR_PATH / 'models_predicts'
PROCESSED_DUSHA_CROWD_TRANSCRIPTIONS_DIR_PATH:Path = PROCESSED_DUSHA_CROWD_MODELS_PREDICTS_DIR_PATH / 'transcriptions'
PROCESSED_DUSHA_CROWD_BIO_DIR_PATH:Path = PROCESSED_DUSHA_CROWD_MODELS_PREDICTS_DIR_PATH / 'bio'

PART_NAME_2_PROCESSED_DUSHA_CROWD_DIR_PATH:Dict[str, Path] = {
    TRAIN_INODE_NAME: PROCESSED_DUSHA_CROWD_TRAIN_DIR_PATH,
    TEST_INODE_NAME: PROCESSED_DUSHA_CROWD_TEST_DIR_PATH,
}
...
BIO_DIR_PATH:Path = MODELS_DIR_PATH / 'bio'
W2V_BIO_DIR_PATH:Path = BIO_DIR_PATH / 'wav2vec2-large-robust-24-ft-age-gender'
